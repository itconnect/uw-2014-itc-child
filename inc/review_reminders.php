    ...
    if (function_exists('get_field')) {
        ...
        if (get_field('reviewed_on', $post->ID)) {
            ...
            if ($reviewedDate < $TenMonthsAgo && $reviewedDate > $OneYearAgo)  {
                ...
                $message = '<div class="review-reminder"><p><span class="review-header">This page should be reviewed soon.</span>It is approaching one year since this content was last reviewed. Plan ahead and set aside some to review this content by it’s next review-by date: <span class="review-by-date">XXX</span>.</p><ul><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/">Learn more about tracking content review</a></li><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/last-reviewed/">See a table of all pages with review and ownership information</a></li></ul></div>';
            } else if ($reviewedDate <= $OneYearAgo) {
                // A year or more since review
                $class = 'notice notice-warning';
                $message = '<div class="review-reminder"><p><span class="review-header">This page is due for a comprehensive review.</span>Based on the content review and ownership fields below on this page, it has been more than a year since this content has undergone a comprehensive review. The content was last marked as reviewed on <span class="last-reviewed-date">XXX.</span>.</p><p>Content on IT Connect should be reviewed a minimum of once per year, and that review should be tracked with the “Last reviewed” and “Reviewed by” content tracking fields in the “Content review and ownership” section of the edit screen of the page.</p><p>Please review the content on this page for accuracy and relevance, and update the page with any new information or changes.</p><ul><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/">Learn more about tracking content review</a></li><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/last-reviewed/">See a table of all pages with review and ownership information</a></li></ul></div>';
            } else {
        ...
        // If reviewed_on field is not filled end, post message that page needs review ASAP
        	...
        	$class = 'notice notice-error';
        	$message = '<div class="review-reminder"><p><span class="review-header">This page has not been marked as reviewed.</span>  Content on IT Connect should be reviewed a minimum of once per year, and that review should be tracked with the “Last reviewed” and “Reviewed by” content tracking fields in the “Content review and ownership” section of the edit screen of the page.</p><p>Please review the content on this page for accuracy and relevance, and update the page with any new information or changes as soon as possible.</p><ul><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/">Learn more about tracking content review</a></li><li><a href="https://itconnect.uw.edu/manager/tracking-content-review/last-reviewed/">See a table of all pages with review and ownership information</a></li></ul></div>';
